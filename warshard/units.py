...
class Unit:
    ...
    def attempt_move_to(self, hex: Hexagon):
        ...
        """
        TODO : implement rivers. These would be on the border of an hex and double movement cost + give defender an advantage.  Full water hexes would represent oceans and impassable rivers only.
        """
    ...
    def try_to_retreat(self, putative_retreat_hex=None):
        ...
        if (putative_retreat_hex is not None) and (
            putative_retreat_hex in potential_retreat_hexes
        ):
